...
public class CurrencyService {
    ...
    public List<CurrencyDtoAbbreviated> getAllCurrency() {
        log.info("CurrencyService method getAllCurrency executed");
        return mapper.getAllCurrency(repository.getAllBy());
    }
}
